...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="ChatBot" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.company.Main %CMD_LINE_ARGS%
